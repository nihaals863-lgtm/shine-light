...
const createNote = async (req, res) => {
    try {
        ...
        const note = await ProgressNote.create({
            ...
            serviceDescription: getField('serviceDescription'),
            faceToFace: getField('faceToFace'),
            faceToFaceIndicator: getField('faceToFaceIndicator'),
            purpose: getField('purpose'),
            intervention: getField('intervention'),
            effectiveness: getField('effectiveness'),
            staffNotes: getField('staffNotes'),
            staffSignature: getField('staffSignature'),
